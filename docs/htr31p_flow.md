...
- 2014-10-21 / 2024-10-17~29 전후 **정기점검 이력** — 계기 교체인지 설비 작업인지 확정.
  다만 §8-3에서 성능 영향이 없음이 확인됐으므로 **우선순위는 낮아졌다.**
- deep-2의 승온폭 34℃가 과거(20℃)보다 높은 이유 — 부하 증가인지 설정 변경인지. 가동률도 2~5배다.
  이건 **모델의 정상범위 정의**에 직접 영향이 있으므로 확인 가치가 있다.
